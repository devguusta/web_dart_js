...
class _MyAppState extends State<MyApp> {
  ...
  Widget demoScreenRouter(DemoScreen which) {
    switch (which) {
      ...
      case DemoScreen.textField:
        return const TextFieldDemo(title: 'Note to Self, pinto');
      case DemoScreen.custom:
        return const CustomDemo(title: 'Character Counter,  pinto');
    }
  }
  ...
  @js.JSExport()
  void setJson(String screenString) {
    Map<String, dynamic> json = jsonDecode(screenString);
    print(json);
  }
}
